...
!-------------------------------------------------------------------------------
    ...
    call t_stopf('drof:readnml')

    !----------------------------------------------------------------------------
    ! Initialize datasets
    !----------------------------------------------------------------------------

    call t_startf('drof:strdata_init')
    ...
    call t_stopf('drof:strdata_init')
    ...
    call t_stopf('drof:initgsmaps')

    !----------------------------------------------------------------------------
    ! Initialize MCT domain
    !----------------------------------------------------------------------------

    call t_startf('drof:initmctdom')
    ...
    call t_stopf('drof:initmctdom')

    !----------------------------------------------------------------------------
    ! Initialize MCT attribute vectors
    !----------------------------------------------------------------------------

    call t_startf('drof:initmctavs')
...
!-------------------------------------------------------------------------------
   ...
   call t_startf('drof:RUN')

   call t_startf('drof:run1')
...
!         write(6,*)'crrentymd, currenttod, nf,n,r2x= ',currentymd, currenttod, nf,n,r2x%rattr(nf,n)
   ...
   call shr_file_setLogLevel(shrloglev)
   call shr_sys_flush(logunit)
   call t_stopf('drof:run2')

   call t_stopf('drof:RUN')
