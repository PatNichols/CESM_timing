...
!-------------------------------------------------------------------------------
   ...
   &                          scmlat=scmlat, scmlon=scmLon)
    ...
    call t_startf('dlnd:strdata_init')
    ...
    call t_stopf('dlnd:strdata_init')
    ...
    call t_stopf('dlnd:initgsmaps')

    !----------------------------------------------------------------------------
    ! Initialize MCT domain
    !----------------------------------------------------------------------------

    call t_startf('dlnd:initmctdom')
    ...
    call t_stopf('dlnd:initmctdom')

    !----------------------------------------------------------------------------
    ! Initialize MCT attribute vectors
    !----------------------------------------------------------------------------

    call t_startf('dlnd:initmctavs')
...
!-------------------------------------------------------------------------------
   ...
   call t_startf('dlnd:RUN')

   call t_startf('dlnd:run1')
  ...
  !----------------------------------------------------------------------------
   ...
   call t_stopf('dlnd:run1')

   !--------------------
   ! UNPACK
   !--------------------

   call t_startf('dlnd:unpack')
...
!   enddo
   ...
   call shr_file_setLogLevel(shrloglev)
   call shr_sys_flush(logunit)
   call t_stopf('dlnd:run2')

   call t_stopf('dlnd:RUN')
