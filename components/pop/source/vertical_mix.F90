...
!-----------------------------------------------------------------------
   ...
   case(vmix_type_const)
      ...
      call get_timer(timer_vmix_coeffs,'OCN:VMIX_COEFFICIENTS_CONSTANT', &
   ...
   case(vmix_type_rich)
      ...
      call get_timer(timer_vmix_coeffs,'OCN:VMIX_COEFFICIENTS_RICH', &
                                  nblocks_clinic, distrb_clinic%nprocs)
   ...
   case(vmix_type_kpp)
      ...
      call get_timer(timer_vmix_coeffs,'OCN:VMIX_COEFFICIENTS_KPP', &
                                  nblocks_clinic, distrb_clinic%nprocs)

   end select

   call get_timer(timer_vdifft,'OCN:VMIX_EXPLICIT_TRACER', &
                               nblocks_clinic, distrb_clinic%nprocs)
   call get_timer(timer_vdiffu,'OCN:VMIX_EXPLICIT_MOMENTUM', &
                               nblocks_clinic, distrb_clinic%nprocs)
...
!-----------------------------------------------------------------------
   ...
   if (implicit_vertical_mix) then
      ...
      call get_timer(timer_impvmixt,'OCN:VMIX_IMPLICIT_TRACER', &
                                   nblocks_clinic, distrb_clinic%nprocs)
      call get_timer(timer_impvmixu,'OCN:VMIX_IMPLICIT_MOMENTUM', &
                                   nblocks_clinic, distrb_clinic%nprocs)
