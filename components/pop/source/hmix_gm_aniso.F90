...
!-----------------------------------------------------------------------
   ...
   if ( diag_gm_bolus ) then
     ...
     call define_tavg_field (tavg_VNS_ISOP, 'VNS_ISOP', 3,                               &
      ...
      call get_timer(timer_gm0,'OCN:GM0',nblocks_clinic, distrb_clinic%nprocs)
      call get_timer(timer_gm1,'OCN:GM1',nblocks_clinic, distrb_clinic%nprocs)
      call get_timer(timer_gm2,'OCN:GM2',nblocks_clinic, distrb_clinic%nprocs)
      call get_timer(timer_gm3,'OCN:GM3',nblocks_clinic, distrb_clinic%nprocs)
      call get_timer(timer_gm4,'OCN:GM4',nblocks_clinic, distrb_clinic%nprocs)
      call get_timer(timer_gm5,'OCN:GM5',nblocks_clinic, distrb_clinic%nprocs)
      call get_timer(timer_gm6,'OCN:GM6',nblocks_clinic, distrb_clinic%nprocs)
      call get_timer(timer_gm7,'OCN:GM7',nblocks_clinic, distrb_clinic%nprocs)
      call get_timer(timer_gm7a,'OCN:GM7a',nblocks_clinic, distrb_clinic%nprocs)
      call get_timer(timer_gm7b,'OCN:GM7b',nblocks_clinic, distrb_clinic%nprocs)
      call get_timer(timer_gm8,'OCN:GM8',nblocks_clinic, distrb_clinic%nprocs)
      call get_timer(timer_gm9,'OCN:GM9',nblocks_clinic, distrb_clinic%nprocs)

      call get_timer(timer_nloop,'OCN:HMIX_TRACER_GM_NLOOP', &
