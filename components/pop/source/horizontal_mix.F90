...
!
! !REVISION HISTORY:
!  SVN:$Id: horizontal_mix.F90 73848 2015-10-05 02:59:57Z mvertens $
!
! !USES:
...
!-----------------------------------------------------------------------
   ...
   case(hmix_momentum_type_del2)
      ...
      call get_timer(timer_hdiffu,'OCN:HMIX_MOMENTUM_DEL2', &
   ...
   case(hmix_momentum_type_del4)
      ...
      call get_timer(timer_hdiffu,'OCN:HMIX_MOMENTUM_DEL4', &
                                  nblocks_clinic, distrb_clinic%nprocs)

   case(hmix_momentum_type_anis)
      call init_aniso 
      call get_timer(timer_hdiffu,'OCN:HMIX_MOMENTUM_ANISO', &
                                  nblocks_clinic, distrb_clinic%nprocs)
   end select
   ...
   case(hmix_tracer_type_del2)
      ...
      call get_timer(timer_hdifft,'OCN:HMIX_TRACER_DEL2', &
                                  nblocks_clinic, distrb_clinic%nprocs)
   ...
   case(hmix_tracer_type_del4)
      ...
      call get_timer(timer_hdifft,'OCN:HMIX_TRACER_DEL4', &
                                  nblocks_clinic, distrb_clinic%nprocs)
   ...
   case(hmix_tracer_type_gm)
      ...
      call get_timer(timer_hdifft,'OCN:HMIX_TRACER_GM', &
                                  nblocks_clinic, distrb_clinic%nprocs)

   case(hmix_tracer_type_gm_aniso)
      call init_meso_mixing(hmix_tracer_itype,hmix_tracer_type_gm,hmix_tracer_type_gm_aniso)
      call init_gm_aniso  ! variables used by GM aniso parameterization
      call get_timer(timer_hdifft,'OCN:HMIX_TRACER_GM_ANISO', &
                                  nblocks_clinic, distrb_clinic%nprocs)
...
!-----------------------------------------------------------------------
   ...
   if ( lsubmesoscale_mixing )  then
        call get_timer(timer_submeso,'OCN:SUBMESO', &
                                  nblocks_clinic, distrb_clinic%nprocs)
   	call init_submeso
