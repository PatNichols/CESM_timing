...
!
! !REVISION HISTORY:
!  SVN:$Id: tavg.F90 73848 2015-10-05 02:59:57Z mvertens $
!  
...
!-----------------------------------------------------------------------
   ...
   call get_timer(timer_write_std,'OCN:TAVG_WRITE_STD', nblocks_clinic, distrb_clinic%nprocs)
   call get_timer(timer_write_nstd,'OCN:TAVG_WRITE_NONSTD', nblocks_clinic, distrb_clinic%nprocs)
   if (ldiag_bsf)  &
   call get_timer(timer_tavg_ccsm_diags_bsf,'OCN:TAVG_CCSM_DIAGS_BSF', nblocks_clinic, distrb_clinic%nprocs)
   if (moc_requested)  &
   call get_timer(timer_tavg_ccsm_diags_moc,'OCN:TAVG_CCSM_DIAGS_MOC', nblocks_clinic, distrb_clinic%nprocs)
   if (n_heat_trans_requested .or. n_salt_trans_requested)  &
   call get_timer(timer_tavg_ccsm_diags_trans,'OCN:TAVG_CCSM_DIAGS_TRANS', nblocks_clinic, distrb_clinic%nprocs)
...
!-----------------------------------------------------------------------
 ...
 call add_attrib_file(tavg_file_desc, 'revision', &
   '$Id: tavg.F90 73848 2015-10-05 02:59:57Z mvertens $')
