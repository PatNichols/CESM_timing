...
!-----------------------------------------------------------------------
   ...
   if (first_call) then
      call get_timer(timer_out, 'OCN:OUTPUT'     ,nblocks_clinic,distrb_clinic%nprocs)
      call get_timer(timer_tavg,'OCN:OUTPUT_TAVG',nblocks_clinic,distrb_clinic%nprocs)
      call get_timer(timer_rest,'OCN:OUTPUT_REST',nblocks_clinic,distrb_clinic%nprocs)
      first_call = .false.
   endif
