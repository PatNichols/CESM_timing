...
!-------------------------------------------------------------------------------
  subroutine sat_hist_write( tape , nflds, nfils)
    ...
    call t_startf ('atm:con:cam_sat_hist_write')
    ...
    call t_stopf ('atm:con:cam_sat_hist_write')
...
!-------------------------------------------------------------------------------
  subroutine dump_columns( File, hitem, ncols, nfils, fdims, ldims, owners  )
    ...
    call t_startf ('atm:con:sat_hist:dump_columns')
    ...
    call t_stopf ('atm:con:sat_hist:dump_columns')
...
!-------------------------------------------------------------------------------
  subroutine read_next_position( ncols )
    ...
    call t_startf ('atm:con:sat_hist::read_next_position')
    ...
    call t_stopf ('atm:con:sat_hist::read_next_position')
...
!-------------------------------------------------------------------------------
  subroutine write_record_coord( tape, mod_lats, mod_lons, mod_dists, ncols, nfils )
    ...
    call t_startf ('atm:con:sat_hist::write_record_coord')
    ...
    call t_stopf ('atm:con:sat_hist::write_record_coord')
...
!-------------------------------------------------------------------------------
  ...
  subroutine get_indices( lats, lons, ncols, nocols, has_dyn_flds, col_ndxs, chk_ndxs, &
    ...
    call t_startf('atm:con:sat_hist::get_indices')
    ...
    call t_stopf ('atm:con:sat_hist::get_indices')
...
!-------------------------------------------------------------------------------
  ...
  subroutine find_cols(lat, lon, nclosest, owner, lcid, icol, gcol, distmin, mlats, mlons)
    ...
    call t_startf ('atm:con:sat_hist:find_cols')
    ...
    call t_stopf ('atm:con:sat_hist:find_cols')
