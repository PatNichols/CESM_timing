...
999 format(a,i0)
  ...
  subroutine h_normalize (f, t)
    ...
    call t_startf ('atm:con:cam_h_normalize')
    ...
    call t_stopf ('atm:con:cam_h_normalize')
  ...
  subroutine h_zero (f, t)
    ...
    call t_startf ('atm:con:cam_h_zero')
    ...
    call t_stopf ('atm:con:cam_h_zero')
...
300         format('WSHIST: writing history restart ',i3,' to hr-file ', &
        ...
        if(is_satfile(t)) then
          ...
          !
          call t_startf ('atm:con:cam_dump_field')
          do f=1,nflds(t)
            call dump_field(f, t, restart)
          end do
          call t_stopf ('atm:con:cam_dump_field')
          !
