...
!
   ...
   call t_startf('atm:phys:rrtmg:mcica_subcol_lw')
   ...
   call t_stopf('atm:phys:rrtmg:mcica_subcol_lw')

   
   call t_startf('atm:phys:rrtmg:rrtmg_lw')
   ...
   call t_stopf('atm:phys:rrtmg:rrtmg_lw')
