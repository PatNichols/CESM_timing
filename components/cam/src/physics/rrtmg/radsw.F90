...
!-----------------------------------------------------------------------
   ...
   call t_startf('atm:phys:rrtmg:mcica_subcol_sw')
   ...
   call t_stopf('atm:phys:rrtmg:mcica_subcol_sw')

   call t_startf('atm:phys:rrtmg:rrtmg_sw')
   ...
   call t_stopf('atm:phys:rrtmg:rrtmg_sw')
