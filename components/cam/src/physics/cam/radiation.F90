    ...
    if (dosw .or. dolw) then
       ...
       if (hist_fld_active('FSNR').or.hist_fld_active('FLNR')) then
        ...
        if (dosw) then
             ...
             call t_startf('atm:phys:cam:rad_sw')
           ...
           ! Get aerosol radiative properties.
             call t_startf('atm:phys:cam:aero_optics_sw')
             call aer_rad_props_sw(0, state, pbuf,  nnite, idxnite, &
                  aer_tau, aer_tau_w, aer_tau_w_g, aer_tau_w_f)
             call t_stopf('atm:phys:cam:aero_optics_sw')
             ...
             call t_stopf('atm:phys:cam:rad_sw')
       ...
       ! Longwave radiation computation
           ...
           if (dolw) then
              ...
              call t_startf('atm:phys:cam:rad_lw')
              ...
              call t_startf('atm:phys:cam:aero_optics_lw')
              if (doabsems) call aer_rad_props_lw(0, state, pbuf, odap_aer)
              call t_stopf('atm:phys:cam:aero_optics_lw')
              ...
              call t_stopf('atm:phys:cam:rad_lw')
