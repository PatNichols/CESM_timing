...
! 
   ...
   call t_startf("atm:phys:cam"//subname)
   ...
   call t_stopf("atm:phys:cam:"//subname)
...
!
   ...
   call t_startf('atm:phys:cam:vert_interpolate')
!
...
!   call t_startf('atm:phys:cam:vi_checks')
!
...
!
   ...
   call t_stopf ('atm:phys:cam:vert_interpolate')
