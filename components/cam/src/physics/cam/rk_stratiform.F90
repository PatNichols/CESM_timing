...
subroutine rk_stratiform_tend( &
  ...
  ! Local variables
   ...
   call t_startf('atm:phys:cam:stratiform_sediment')
   ...
   call t_stopf('atm:phys:cam:stratiform_sediment')
   ...
   call t_startf('atm:phys:cam:cldfrc')
   ...
   call t_stopf('atm:phys:cam:cldfrc')
   ...
   call t_startf('atm:phys:cam:stratiform_microphys')
   ...
   call t_startf('atm:phys:cam:pcond')
   ...
   call t_stopf('atm:phys:cam:pcond')
   ...
   call t_stopf('atm:phys:cam:stratiform_microphys')
