...
!-----------------------------------------------------------------------
 subroutine advance_spedata()
    ...
    call t_startf('atm:chem:MET__advance')
...
! each mpi tasks needs to interpolate
    ...
    call t_stopf('atm:chem:MET__advance')
...
!------------------------------------------------------------------------------
  ...
  subroutine get_model_time()
    ...
    call t_startf('atm:chem:MET_get_model_time')
    ...
    call t_stopf('atm:chem:MET_get_model_time')
...
!------------------------------------------------------------------------
    ...
    integer :: ierr
    call t_startf('atm:chem:MET__read_next_spedata')
    ...
    call t_stopf('atm:chem:MET__read_next_spedata')
...
!------------------------------------------------------------------------------
  subroutine interpolate_spedata()
    ...
    call t_startf('atm:chem:MET__interpolate_spedata')
    ...
    call t_stopf('atm:chem:MET__interpolate_spedata')
