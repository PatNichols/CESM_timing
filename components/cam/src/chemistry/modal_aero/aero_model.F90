...
!         if (lphase == 1) then
  ...
  subroutine aero_model_wetdep( state, dt, dlf, cam_out, ptend, pbuf)
    ...
    call t_startf('atm:chem:calcsize')
    ...
    call t_stopf('atm:chem:calcsize')

    call t_startf('atm:chem:wateruptake')
    call modal_aero_wateruptake_dr(state, pbuf)
    call t_stopf('atm:chem:wateruptake')
...
! do gas-aerosol exchange (h2so4, msa, nh3 condensation)
    ...
    call t_startf('atm:chem:modal_gas-aer_exchng')
    ...
    call t_stopf('atm:chem:modal_gas-aer_exchng')

    call t_startf('atm:chem:modal_nucl')
    ...
    call t_stopf('atm:chem:modal_nucl')

    call t_startf('atm:chem:modal_coag')
    ...
    call t_stopf('atm:chem:modal_coag')
