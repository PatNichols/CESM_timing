...
!-----------------------------------------------------------------------
 subroutine advance_met(grid)
   ...
   call t_startf('atm:dyn:fv:dyn:fv:MET__advance')
...
! each mpi tasks needs to interpolate
    ...
    call t_stopf('atm:dyn:fv:MET__advance')
...
!-------------------------------------------------------------------
  subroutine get_dyn_flds( state, tend, dt )
    ...
    call t_startf('atm:dyn:fv:dyn:fv:MET__GET_DYN2')
...
!!$             endif
    ...
    enddo
    call t_stopf('atm:dyn:fv:MET__GET_DYN2')
...
!------------------------------------------------------------------------
  subroutine get_us_vs( grid, us, vs )
    ...
    call t_startf('atm:dyn:fv:dyn:fv:MET__get_us_vs')
...
!!$    endif
!!$
    call t_stopf('atm:dyn:fv:MET__get_us_vs')
...
!-------------------------------------------------------------------------
  subroutine transfer_windsToWalls(grid)
    ...
    call t_startf('atm:dyn:fv:dyn:fv:MET__transfer_windsToWalls')
...
!$omp parallel do private (i, j, k)
    ...
    call t_stopf('atm:dyn:fv:MET__transfer_windsToWalls')
  ...
  subroutine get_model_time()
    ...
    call t_startf('atm:dyn:fv:dyn:fv:MET__get_model_time')
    ...
    call t_stopf('atm:dyn:fv:MET__get_model_time')
...
!------------------------------------------------------------------------
  subroutine read_next_metdata(grid)
    ...
    call t_startf('atm:dyn:fv:dyn:fv:MET__read_next_metdata')
    ...
    call t_stopf('atm:dyn:fv:MET__read_next_metdata')
...
!------------------------------------------------------------------------------
  subroutine interpolate_metdata(grid)
    ...
    call t_startf('atm:dyn:fv:dyn:fv:MET__interpolate_metdata')
...
!    write(iulog,*)'INTERPOLATE_METDATA: complete.'
    ...
    call t_stopf('atm:dyn:fv:MET__interpolate_metdata')
