...
!
   !!!     call t_startf('atm:dyn:fv:ghost_creation')
...
! Ghosted decompositions needed on xy decomposition for parpatterncreate
   ...
   !!!     call t_stopf('atm:dyn:fv:ghost_creation')

! Initialize transposes
!
   !!!     call t_startf('atm:dyn:fv:transpose_creation')
...
! These are for 'transposing' 2D arrays from XY YZ
   ...
   !!!     call t_stopf('atm:dyn:fv:transpose_creation')
