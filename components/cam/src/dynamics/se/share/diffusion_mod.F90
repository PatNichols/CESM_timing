...
contains
  ...
  subroutine prim_diffusion(elem, nets,nete,np1,deriv,dt2,hybrid)
    ...
    call t_startf('atm:dyn:se:prim_diffusion')
...
!$OMP BARRIER
#endif
#endif
    call t_stopf('atm:dyn:se:prim_diffusion')
  ...
  subroutine scalar_diffusion(elem, nets,nete,np1,deriv,dt2,hybrid)
    ...
    call t_startf('atm:dyn:se:scalar_diffusion')
    do ie=nets,nete
       do q=1,qsize
...
#endif
#endif
    call t_stopf('atm:dyn:se:scalar_diffusion')
