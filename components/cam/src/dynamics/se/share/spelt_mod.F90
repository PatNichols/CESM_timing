...
!   call t_startf('atm:dyn:se:SPELT scheme')
...
!-----------------------------------------------------------------------------------!
!   call t_startf('atm:dyn:se:SPELT Communication')
  call ghost_exchangeV(hybrid,cellghostbuf,nipm,nep,ntrac)
!   call t_stopf('atm:dyn:se:SPELT Communication')
!-----------------------------------------------------------------------------------!
!   call t_startf('atm:dyn:se:SPELT Unpacking')
  do ie=nets,nete
    call ghostVunpack2d(cellghostbuf,spelt(ie)%c,nipm, nep,nlev,ntrac,0, tl%np1, timelevels,elem(ie)%desc)
  end do
!   call t_stopf('atm:dyn:se:SPELT Unpacking')
!   call t_stopf('atm:dyn:se:SPELT scheme')
...
!   call t_startf('atm:dyn:se:SPELT Communication1')
  call ghost_exchangeV(hybrid,factorR,nhe,nc,ntrac)
!   call t_stopf('atm:dyn:se:SPELT Communication1')
...
!-----------------------------------------------------------------------------------!
!   call t_startf('atm:dyn:se:SPELT Communication2')
  call ghost_exchangeV(hybrid,cellghostbuf,nipm,nep,ntrac)
!   call t_stopf('atm:dyn:se:SPELT Communication2')
!-----------------------------------------------------------------------------------!
!   call t_startf('atm:dyn:se:SPELT Unpacking2')
  do ie=nets,nete
    call ghostVunpack2d(cellghostbuf,spelt(ie)%c,nipm, nep,nlev,ntrac,0, tl%np1, timelevels,elem(ie)%desc)
  end do
!   call t_stopf('atm:dyn:se:SPELT Unpacking2')
!   call t_stopf('atm:dyn:se:SPELT scheme')
