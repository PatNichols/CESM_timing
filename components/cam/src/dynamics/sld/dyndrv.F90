...
!
  ...
  call t_startf('atm:dyn:sld:quad')
...
!
   ...
   call t_stopf('atm:dyn:sld:quad')

   call t_startf('atm:dyn:sld:tstep')
...
!$OMP PARALLEL DO PRIVATE(K)
  ...
  call t_stopf('atm:dyn:sld:hordif')
