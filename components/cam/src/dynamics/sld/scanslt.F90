...
!
  ...
  call t_startf('atm:dyn:sld:da_coupling')
  call da_coupling( adv_state, cwava, lnpssld, prhssld )
  call t_stopf('atm:dyn:sld:da_coupling')
...
!
  ...
  call t_startf('atm:dyn:sld:bndexch')
  call bndexch( adv_state )
  call t_stopf('atm:dyn:sld:bndexch')
#endif
...
!
!
  call t_startf('atm:dyn:sld:scanslt_alloc')
...
#endif
  call t_stopf('atm:dyn:sld:scanslt_alloc')

  call t_startf('atm:dyn:sld:scanslt_bft')
!$OMP PARALLEL DO PRIVATE(LAT)
  ...
  call t_stopf('atm:dyn:sld:scanslt_bft')
!
  call t_startf('atm:dyn:sld:scanslt_fft')
  call scanslt_fft(nlon_fft_in,nlon_fft_out,fftbuf_in,fftbuf_out)
  call t_stopf('atm:dyn:sld:scanslt_fft')
!
  call t_startf('atm:dyn:sld:scanslt_aft')
!$OMP PARALLEL DO PRIVATE (IROW, LATN, LATS)
  ...
  call t_stopf('atm:dyn:sld:scanslt_aft')

  call t_startf('atm:dyn:sld:scanslt_dealloc')
  deallocate(fftbuf_in)
  deallocate(fftbuf_out)
  call t_stopf('atm:dyn:sld:scanslt_dealloc')

  call t_startf('atm:dyn:sld:ad_coupling')
  call ad_coupling( adv_state )
  call t_stopf('atm:dyn:sld:ad_coupling')
...
!
   call t_barrierf ('atm:dyn:sld:sync_realloc4a', mpicom)
   call t_startf('atm:dyn:sld:realloc4a')
   call realloc4a(nlon_fft, nlon_fft2, fftbuf, fftbuf2)
   call t_stopf('atm:dyn:sld:realloc4a')
#endif
