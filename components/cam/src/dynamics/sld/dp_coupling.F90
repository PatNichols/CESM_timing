...
!DIR$ CONCURRENT
       ...
       call t_barrierf ('atm:dyn:sld:sync_blk_to_chk', mpicom)
       call t_startf('atm:dyn:sld:block_to_chunk')
       call transpose_block_to_chunk(tsize, buf1, buf2, buf2win)
       call t_stopf('atm:dyn:sld:block_to_chunk')
...
!DIR$ CONCURRENT
       ...
       call t_barrierf ('atm:dyn:sld:sync_chk_to_blk', mpicom)
       call t_startf('atm:dyn:sld:chunk_to_block')
       call transpose_chunk_to_block(tsize, buf2, buf1, buf1win)
       call t_stopf('atm:dyn:sld:chunk_to_block')
