...
!
   ...
   call t_startf('atm:dyn:eu:stepon_startup')
   ...
   !
   call t_stopf('atm:dyn:eu:stepon_startup')
...
!----------------------------------------------------------------------- 
  ...
  call t_startf('atm:dyn:eu:diag_dynvar_ic')
  ...
  call t_stopf('atm:dyn:eu:diag_dynvar_ic')
  !
  !----------------------------------------------------------
  ! Couple from dynamics to physics
  !----------------------------------------------------------
  !
  call t_startf('atm:dyn:eu:d_p_coupling')
  ...
  call t_stopf('cam:dyn:eu:d_p_coupling')
...
!----------------------------------------------------------------------- 
  ...
  call t_startf('atm:dyn:eu:p_d_coupling')
...
!----------------------------------------------------------------------- 
  ...
  !----------------------------------------------------------
  call t_startf('atm:dyn:eu:dynpkg')
