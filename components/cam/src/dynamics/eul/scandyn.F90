...
!
   call t_startf('atm:dyn:eu:scandyn_alloc')
...
#endif
   call t_stopf('atm:dyn:eu:scandyn_alloc')
!
   call t_startf('atm:dyn:eu:linemsdyn_bft')
#ifdef OUTER_OMP
!$OMP PARALLEL DO PRIVATE (LAT)
   ...
   call t_stopf('atm:dyn:eu:linemsdyn_bft')

   call t_startf('atm:dyn:eu:linemsdyn_fft')
   call linemsdyn_fft (nlon_fft_in,nlon_fft_out,fftbuf_in,fftbuf_out)
   call t_stopf('atm:dyn:eu:linemsdyn_fft')

   call t_startf('atm:dyn:eu:linemsdyn_aft')
!$OMP PARALLEL DO PRIVATE (IROW, LATN, LATS)
   ...
   call t_stopf('atm:dyn:eu:linemsdyn_aft')
!
   call t_startf('atm:dyn:eu:scandyn_dealloc')
   deallocate(fftbuf_in)
   deallocate(fftbuf_out)
   call t_stopf('atm:dyn:eu:scandyn_dealloc')

!
   call t_startf('atm:dyn:eu:moisture_mass')
!
...
!  qminus is plon,plev,pcnst,beglat:endlat
   ...
   call t_stopf('atm:dyn:eu:moisture_mass')
