...
!
   call t_startf('atm:dyn:eu:scanslt_da_coup')
   call da_coupling( cwava, adv_state )
   call t_stopf('atm:dyn:eu:scanslt_da_coup')
!
...
!
      ...
      call t_startf('atm:dyn:eu:bndexch')
      call bndexch( adv_state )
      call t_stopf('atm:dyn:eu:bndexch')
#endif
...
!
   call t_startf('atm:dyn:eu:sltb1')
#ifdef OUTER_OMP
...
!
   ...
   call t_stopf('atm:dyn:eu:sltb1')
!
! Copy SLT advection structure data back into dynamics data
!
   call t_startf('atm:dyn:eu:scanslt_ad_coup')
   call ad_coupling( adv_state )
   call t_stopf('atm:dyn:eu:scanslt_ad_coup')
   return
...
!
   call t_startf('atm:dyn:eu:slt_single')
...
!
   ...
   call t_stopf('atm:dyn:eu:slt_single')
!
