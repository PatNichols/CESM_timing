...
#if defined( WRAP_MPI_TIMING )
      call t_startf('atm:utils:fc_gatherv_r8')
#endif
...
#if defined( WRAP_MPI_TIMING )
      call t_stopf('atm:utils:fc_gatherv_r8')
#endif
...
#if defined( WRAP_MPI_TIMING )
      call t_startf('atm:utils:fc_gatherv_r4')
#endif
      call mpi_comm_rank (comm, mytid, ier)
      call mpi_comm_size (comm, mysize, ier)
      mtag = 0
...
#if defined( WRAP_MPI_TIMING )
      call t_stopf('atm:utils:fc_gatherv_r4')
#endif
...
#if defined( WRAP_MPI_TIMING )
      call t_startf('atm:utils:fc_gatherv_int')
#endif
      call mpi_comm_rank (comm, mytid, ier)
      call mpi_comm_size (comm, mysize, ier)
      mtag = 0
...
#if defined( WRAP_MPI_TIMING )
      call t_stopf('atm:utils:fc_gatherv_int')
#endif
...
#if defined( WRAP_MPI_TIMING )
      call t_startf('atm:utils:fc_gatherv_char')
#endif
      call mpi_comm_rank (comm, mytid, ier)
      call mpi_comm_size (comm, mysize, ier)
      mtag = 0
...
#if defined( WRAP_MPI_TIMING )
      call t_stopf('atm:utils:fc_gatherv_char')
#endif
...
#if ( defined CAF )
#if defined( WRAP_MPI_TIMING )
         call t_startf('atm:utils:caf_alltoallv')
#endif
...
!DIR$ CONCURRENT
         ...
         call sync_images()
#if defined( WRAP_MPI_TIMING )
         call t_stopf('atm:utils:caf_alltoallv')
#endif
#else
         loption = -1
#endif
...
#ifdef MPI2
#if defined( WRAP_MPI_TIMING )
         call t_startf('atm:utils:mpi2_alltoallv')
#endif
...
#if defined( WRAP_MPI_TIMING )
         call t_stopf('atm:utils:mpi2_alltoallv')
#endif
#else
         loption = -1
#endif
...
#if defined( WRAP_MPI_TIMING )
         call t_startf('atm:utils:swap_alltoallv')
#endif
...
!
#if defined( WRAP_MPI_TIMING )
         call t_stopf('atm:utils:swap_alltoallv')
#endif
...
#if defined( WRAP_MPI_TIMING )
         call t_startf('atm:utils:mpi1_alltoallv')
#endif
         do i=1, steps
            dest = dests(i)
...
#if defined( WRAP_MPI_TIMING )
         call t_stopf('atm:utils:mpi1_alltoallv')
#endif
      endif
