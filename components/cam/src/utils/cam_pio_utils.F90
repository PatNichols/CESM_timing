...
contains
  ...
  subroutine cam_pio_get_decomp(iodesc, ldims, fdims, dtype, map,             &
    ...
    call t_startf('atm:utils:pio:get_decomp')
    ...
    if (.not. found) then
      ...
      call t_startf('atm:utils:pio:newdecomp')
      call cam_pio_newdecomp(iodesc_p%iodesc, fdims, dof, dtype)
      call t_stopf('atm:utils:pio:newdecomp')
    ...
    call t_stopf('atm:utils:pio:get_decomp')
