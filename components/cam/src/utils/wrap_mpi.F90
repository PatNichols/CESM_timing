...
#if defined( WRAP_MPI_TIMING )
   call t_startf('atm:utils:mpi_sendrecv')
#endif
...
#if defined( WRAP_MPI_TIMING )
   call t_stopf('atm:utils:mpi_sendrecv')
#endif
...
!
...
#if defined( WRAP_MPI_TIMING )
   call t_startf('atm:utils:mpi_isend')
#endif
   ...
   nwsend = nwsend + count
#if defined( WRAP_MPI_TIMING )
   call t_stopf('atm:utils:mpi_isend')
#endif
...
!
...
#if defined( WRAP_MPI_TIMING )
   call t_startf('atm:utils:mpi_irsend')
#endif
   ...
   nwsend = nwsend + count
#if defined( WRAP_MPI_TIMING )
   call t_stopf('atm:utils:mpi_irsend')
#endif
...
!
...
#if defined( WRAP_MPI_TIMING )
   call t_startf('atm:utils:mpi_issend')
#endif
   ...
   nwsend = nwsend + count
#if defined( WRAP_MPI_TIMING )
   call t_stopf('atm:utils:mpi_issend')
#endif
...
!
...
#if defined( WRAP_MPI_TIMING )
   call t_startf('atm:utils:mpi_irecv')
#endif
   ...
   nwrecv = nwrecv + count
#if defined( WRAP_MPI_TIMING )
   call t_stopf('atm:utils:mpi_irecv')
#endif
...
#if defined( WRAP_MPI_TIMING )
   call t_startf('atm:utils:mpi_wait')
#endif
...
#if defined( WRAP_MPI_TIMING )
   call t_stopf('atm:utils:mpi_wait')
#endif
...
#if defined( WRAP_MPI_TIMING )
   call t_startf('atm:utils:mpi_waitall')
#endif
...
#if defined( WRAP_MPI_TIMING )
   call t_stopf('atm:utils:mpi_waitall')
#endif
...
!
...
#if defined( WRAP_MPI_TIMING )
   call t_startf('atm:utils:mpi_send')
#endif
   ...
   nwsend = nwsend + count
#if defined( WRAP_MPI_TIMING )
   call t_stopf('atm:utils:mpi_send')
#endif
...
!
...
#if defined( WRAP_MPI_TIMING )
   call t_startf('atm:utils:mpi_rsend')
#endif
   ...
   nwsend = nwsend + count
#if defined( WRAP_MPI_TIMING )
   call t_stopf('atm:utils:mpi_rsend')
#endif
...
!
...
#if defined( WRAP_MPI_TIMING )
   call t_startf('atm:utils:mpi_ssend')
#endif
   ...
   nwsend = nwsend + count
#if defined( WRAP_MPI_TIMING )
   call t_stopf('atm:utils:mpi_ssend')
#endif
...
!
...
#if defined( WRAP_MPI_TIMING )
   call t_startf('atm:utils:mpi_recv')
#endif
   ...
   nwrecv = nwrecv + count
#if defined( WRAP_MPI_TIMING )
   call t_stopf('atm:utils:mpi_recv')
#endif
...
#if defined( WRAP_MPI_TIMING )
   call t_startf('atm:utils:mpi_gather')
#endif
...
#if defined( WRAP_MPI_TIMING )
   call t_stopf('atm:utils:mpi_gather')
#endif
...
#if defined( WRAP_MPI_TIMING )
   call t_startf('atm:utils:mpi_gatherv')
#endif
...
#if defined( WRAP_MPI_TIMING )
   call t_stopf('atm:utils:mpi_gatherv')
#endif
...
#if defined( WRAP_MPI_TIMING )
   call t_startf('atm:utils:mpi_reduce')
#endif
...
#if defined( WRAP_MPI_TIMING )
   call t_stopf('atm:utils:mpi_reduce')
#endif
...
#if defined( WRAP_MPI_TIMING )
   call t_startf('atm:utils:mpi_scatter')
#endif
...
#if defined( WRAP_MPI_TIMING )
   call t_stopf('atm:utils:mpi_scatter')
#endif
...
#if defined( WRAP_MPI_TIMING )
   call t_startf('atm:utils:mpi_bcast')
#endif
...
#if defined( WRAP_MPI_TIMING )
   call t_stopf('atm:utils:mpi_bcast')
#endif
...
#if defined( WRAP_MPI_TIMING )
   call t_startf('atm:utils:mpi_allreduce')
#endif
...
#if defined( WRAP_MPI_TIMING )
   call t_stopf('atm:utils:mpi_allreduce')
#endif
...
#if defined( WRAP_MPI_TIMING )
   call t_startf('atm:utils:mpi_alltoallv')
#endif
...
#if defined( WRAP_MPI_TIMING )
   call t_stopf('atm:utils:mpi_alltoallv')
#endif
...
#if defined( WRAP_MPI_TIMING )
   call t_startf('atm:utils:mpi_alltoallint')
#endif
...
#if defined( WRAP_MPI_TIMING )
   call t_stopf('atm:utils:mpi_alltoallint')
#endif
...
#if defined( WRAP_MPI_TIMING )
   call t_startf('atm:utils:mpi_allgatherv')
#endif
...
#if defined( WRAP_MPI_TIMING )
   call t_stopf('atm:utils:mpi_allgatherv')
#endif
...
#if defined( WRAP_MPI_TIMING )
   call t_startf('atm:utils:mpi_allgather')
#endif
...
#if defined( WRAP_MPI_TIMING )
   call t_stopf('atm:utils:mpi_allgather')
#endif
...
!
#if defined( WRAP_MPI_TIMING )
   call t_startf('atm:utils:mpi_win_create')
#endif
   info = MPI_INFO_NULL
   size8 = size
...
#if defined( WRAP_MPI_TIMING )
   call t_stopf('atm:utils:mpi_win_create')
#endif
#endif
