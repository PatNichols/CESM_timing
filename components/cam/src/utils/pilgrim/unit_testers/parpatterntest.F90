...
#if defined(TIMING)
      call t_startf('atm:utils:pilgrim:unit_testers:1D Redist Total')
#endif
...
!
#if defined(TIMING)
      call t_startf('atm:utils:pilgrim:unit_testers:1D Redist Create')
#endif
      CALL ParPatternCreate( CommGlobal, DecompA, DecompB, InterAB )
      CALL ParPatternCreate( CommGlobal, DecompB, DecompA, InterBA )
#if defined(TIMING)
      call t_stopf('atm:utils:pilgrim:unit_testers:1D Redist Create')
#endif

#if defined(TIMING)
      call t_startf('atm:utils:pilgrim:unit_testers:1D Redist Forward')
#endif
      CALL ParBeginTransfer( InterAB, RlocalA, RlocalB )
      CALL ParEndTransfer( InterAB, RlocalA, RlocalB )
#if defined(TIMING)
      call t_stopf('atm:utils:pilgrim:unit_testers:1D Redist Forward')
#endif
      RlocalA = 0.0_r8

#if defined(TIMING)
      call t_startf('atm:utils:pilgrim:unit_testers:1D Redist Back')
#endif
      CALL ParBeginTransfer( InterBA, RlocalB, RlocalA )
      CALL ParEndTransfer( InterBA, RlocalB, RlocalA )
#if defined(TIMING)
      call t_stopf('atm:utils:pilgrim:unit_testers:1D Redist Back')
#endif
...
#if defined(TIMING)
      call t_stopf('atm:utils:pilgrim:unit_testers:1D Redist Total')
#endif
...
!
#if defined(TIMING)
      call t_startf('atm:utils:pilgrim:unit_testers:2D Redist Total')
#endif
...
#if defined(TIMING)
      call t_startf('atm:utils:pilgrim:unit_testers:2D Redist Create')
#endif
      CALL ParPatternCreate( CommGlobal, DecompA, DecompB, InterAB )
      CALL ParPatternCreate( CommGlobal, DecompB, DecompA, InterBA )

#if defined(TIMING)
      call t_stopf('atm:utils:pilgrim:unit_testers:2D Redist Create')
#endif
#if defined(TIMING)
      call t_startf('atm:utils:pilgrim:unit_testers:2D Redist Forward')
#endif
      CALL ParBeginTransfer( InterAB, R2dlocalA, R2dlocalB )
      CALL ParEndTransfer( InterAB, R2dlocalA, R2dlocalB )
#if defined(TIMING)
      call t_stopf('atm:utils:pilgrim:unit_testers:2D Redist Forward')
#endif
      R2dlocalA = 0.0_r8
#if defined(TIMING)
      call t_startf('atm:utils:pilgrim:unit_testers:2D Redist Back')
#endif
      CALL ParBeginTransfer( InterBA, R2dlocalB, R2dlocalA )
      CALL ParEndTransfer( InterBA, R2dlocalB, R2dlocalA )
#if defined(TIMING)
      call t_stopf('atm:utils:pilgrim:unit_testers:2D Redist Back')
#endif
...
#if defined(TIMING)
      call t_stopf('atm:utils:pilgrim:unit_testers:2D Redist Total')
#endif
...
!
#if defined(TIMING)
      call t_startf('atm:utils:pilgrim:unit_testers:3D Redist Total')
#endif
...
#if defined( TIMING )
      call t_startf('atm:utils:pilgrim:unit_testers:3D Redist Create')
#endif
...
#if defined(TIMING)
      call t_stopf('atm:utils:pilgrim:unit_testers:3D Redist Create')
#endif
#if defined(TIMING)
      call t_startf('atm:utils:pilgrim:unit_testers:3D Redist Forward')
#endif
      CALL ParBeginTransfer( InterAB, R3dlocalA, R3dlocalB )
      CALL ParEndTransfer( InterAB, R3dlocalA, R3dlocalB )
#if defined(TIMING)
      call t_stopf('atm:utils:pilgrim:unit_testers:3D Redist Forward')
#endif
      R3dlocalA = 0.0_r8
#if defined(TIMING)
      call t_startf('atm:utils:pilgrim:unit_testers:3D Redist Back')
#endif
      CALL ParBeginTransfer( InterBA, R3dlocalB, R3dlocalA )
      CALL ParEndTransfer( InterBA, R3dlocalB, R3dlocalA )
#if defined(TIMING)
      call t_stopf('atm:utils:pilgrim:unit_testers:3D Redist Back')
#endif
      CALL ParPatternFree( CommGlobal, InterAB )
      CALL ParPatternFree( CommGlobal, InterBA )
...
#if defined(TIMING)
      call t_stopf('atm:utils:pilgrim:unit_testers:3D Redist Total')
#endif
