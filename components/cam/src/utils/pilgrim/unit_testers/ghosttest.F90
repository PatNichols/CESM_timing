...
!
#if defined(TIMING)
      call t_startf('atm:utils:pilgrim:unit_testers:1D Ghosting Total')
#endif
...
!
#if defined(TIMING)
      call t_startf('atm:utils:pilgrim:unit_testers:1D PatternCreate')
#endif
      CALL ParPatternCreate( CommGlobal, Ghost, Pattern )
#if defined(TIMING)
      call t_stopf('atm:utils:pilgrim:unit_testers:1D PatternCreate')
#endif
...
!
#if defined(TIMING)
      call t_startf('atm:utils:pilgrim:unit_testers:1D Ghost Transfer')
#endif
      CALL ParBeginTransfer( Pattern, Rtmp, Rtmp )
      CALL ParEndTransfer( Pattern, Rtmp, Rtmp )
#if defined(TIMING)
      call t_stopf('atm:utils:pilgrim:unit_testers:1D Ghost Transfer')
#endif
...
#if defined(TIMING)
      call t_stopf('atm:utils:pilgrim:unit_testers:1D Ghosting Total')
#endif
...
#if defined(TIMING)
      call t_startf('atm:utils:pilgrim:unit_testers:2D Ghosting Total')
#endif
      IF ( Gsize .GT. 1 ) THEN
        PEsInX = 2
...
#if defined(TIMING)
      call t_startf('atm:utils:pilgrim:unit_testers:2D PatternCreate')
#endif
      CALL ParPatternCreate( CommGlobal, Ghost, Pattern2d )
#if defined(TIMING)
      call t_stopf('atm:utils:pilgrim:unit_testers:2D PatternCreate')
#endif
...
!
#if defined(TIMING)
      call t_startf('atm:utils:pilgrim:unit_testers:2D Ghost Transfer')
#endif
      CALL ParBeginTransfer( Pattern2d, Rtmp2d, Rtmp2d )
      CALL ParEndTransfer( Pattern2d, Rtmp2d, Rtmp2d )
#if defined(TIMING)
      call t_stopf('atm:utils:pilgrim:unit_testers:2D Ghost Transfer')
#endif
...
#if defined(TIMING)
      call t_stopf('atm:utils:pilgrim:unit_testers:2D Ghosting Total')
#endif
...
!
#if defined(TIMING)
      call t_startf('atm:utils:pilgrim:unit_testers:3D Ghosting Total')
#endif
!
...
!
      ...
      ENDDO
#if defined(TIMING)
      call t_startf('atm:utils:pilgrim:unit_testers:3D PatternCreate')
#endif
      CALL ParPatternCreate( CommGlobal, Ghost, Pattern3d )
#if defined(TIMING)
      call t_stopf('atm:utils:pilgrim:unit_testers:3D PatternCreate')
#endif
...
!
#if defined(TIMING)
      call t_startf('atm:utils:pilgrim:unit_testers:3D Ghost Transfer')
#endif
      CALL BeginTransfer( Pattern3d, Rtmp3d, Rtmp3d )
      CALL EndTransfer( Pattern3d, Rtmp3d, Rtmp3d )
#if defined(TIMING)
      call t_stopf('atm:utils:pilgrim:unit_testers:3D Ghost Transfer')
#endif
...
!
      ...
      CALL DecompFree( Decomp )
#if defined(TIMING)
      call t_stopf('atm:utils:pilgrim:unit_testers:3D Ghosting Total')
#endif
