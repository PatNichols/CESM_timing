...
#ifdef DEBUG
		     call t_startf('cam:nln_mat')
#endif
                     call nlnmat( sys_jac, lsol, lrxt, lin_jac, dti, cols )
#ifdef DEBUG
		     call t_stopf('cam:nln_mat')
		     call t_startf('cam:lu_fac')
#endif
!-----------------------------------------------------------------------      
...
#ifdef DEBUG
		  call t_stopf('cam:frcing')
		  call t_startf('cam:lu_slv')
#endif
!-----------------------------------------------------------------------      
...
#ifdef DEBUG
		  call t_stopf('cam:lu_slv')
#endif
!-----------------------------------------------------------------------      
!    	... Convergence measures
!-----------------------------------------------------------------------      
#ifdef DEBUG
                  call t_startf('cam:inner1_conv')
#endif
                  if( nr_iter > 1 ) then
	             do k = 1,clscnt4
		        m = permute(k,4)
...
#ifdef DEBUG
                  call t_stopf('cam:inner1_conv')
                  call t_startf('cam:inner2_conv')
#endif
!-----------------------------------------------------------------------      
!   	... Limit iterate
!-----------------------------------------------------------------------      
...
#ifdef DEBUG
                  call t_stopf('cam:inner2_conv')
                  call t_startf('cam:inner3_conv')
#endif
!-----------------------------------------------------------------------      
