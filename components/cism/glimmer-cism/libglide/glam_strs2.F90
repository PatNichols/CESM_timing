...
subroutine glam_velo_solver(ewn,      nsn,    upn,  &
 ...
 call t_startf("cism:glide:PICARD_pre")
...
!==============================================================================
 ...
 call t_stopf("cism:glide:PICARD_pre")
  ! ****************************************************************************************
  ! START of Picard iteration
  ! ****************************************************************************************
 call t_startf("cism:glide:PICARD_iter")
 ...
 call t_startf("cism:glide:PICARD_in_iter")
 ...
 call t_startf("cism:glide:PICARD_findefvsstr")
    ...
    call findefvsstr(ewn,  nsn,  upn,      &
                     ...
                     dusrfdns,   dthckdns, &
                     umask)
 call t_stopf("cism:glide:PICARD_findefvsstr")

 call t_startf("cism:glide:PICARD_findcoefstr1")
    ...
    call findcoefstr(ewn,  nsn,   upn,            &
                     ...
                     btraction,                   &
                     0 )
 call t_stopf("cism:glide:PICARD_findcoefstr1")

 call t_startf("cism:glide:PICARD_solver_pre1")
    ! put vels and coeffs from 3d arrays into sparse vector format
    call solver_preprocess( ewn, nsn, upn, uindx, matrix, answer, vvel )
 call t_stopf("cism:glide:PICARD_solver_pre1")
...
!==============================================================================
 ...
 call t_startf("cism:glide:PICARD_res_vect")
    call res_vect( matrix, vk_1, rhsd, size(rhsd), g_flag, L2square, whichsparse ) 
 call t_stopf("cism:glide:PICARD_res_vect")
...
!==============================================================================
 ...
 call t_startf("cism:glide:PICARD_solvea")
  if (whatsparse /= STANDALONE_TRILINOS_SOLVER) then
 ...
 call t_stopf("cism:glide:PICARD_solvea")
...
! >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
 ...
 call t_startf("cism:glide:PICARD_findcoefstr2")
 ...
 call t_stopf("cism:glide:PICARD_findcoefstr2")

 call t_startf("cism:glide:PICARD_solver_pre2")
    ! put vels and coeffs from 3d arrays into sparse vector format
    call solver_preprocess( ewn, nsn, upn, uindx, matrix, answer, uvel )
 call t_stopf("cism:glide:PICARD_solver_pre2")
...
!==============================================================================
 ...
 call t_startf("cism:glide:PICARD_solveb")
  if (whatsparse /= STANDALONE_TRILINOS_SOLVER) then
     call sparse_easy_solve(matrix, rhsd, answer, err, iter, whichsparse)
#ifdef TRILINOS
  else
 ...
 call t_stopf("cism:glide:PICARD_solveb")
...
!==============================================================================
 ...
 call t_startf("cism:glide:PICARD_findcoefstr3")
    call findcoefstr(ewn,  nsn,   upn,            &
                     dew,  dns,   sigma,          &
                     2,           efvs,           &
                     tvel,        uvel,           &
 ...
 call t_stopf("cism:glide:PICARD_findcoefstr3")

    ! apply unstable manifold correction to converged velocities

 call t_startf("cism:glide:PICARD_mindcrsh")
...
!       
 ...
 call t_stopf("cism:glide:PICARD_in_iter")
  ...
  ! ****************************************************************************************
 call t_stopf("cism:glide:PICARD_iter")

 call t_startf("cism:glide:PICARD_post")
...
!        locally owned velocity points.
 ...
 call t_stopf("cism:glide:PICARD_post")
...
!*SFP* needed to incorporate generic wrapper to solver
 ...
 call t_startf("cism:glide:JFNK_pre")
...
if (main_task) then
 ...
 call t_stopf("cism:glide:JFNK_pre")
...
!==============================================================================
 ...
 call t_startf("cism:glide:JFNK_noxinit")
  call noxinit(xk_size, xk_1, comm, c_ptr_to_object)
 call t_stopf("cism:glide:JFNK_noxinit")

 call t_startf("cism:glide:JFNK_noxsolve")
  call noxsolve(xk_size, xk_1, c_ptr_to_object)
 call t_stopf("cism:glide:JFNK_noxsolve")

 call t_startf("cism:glide:JFNK_noxfinish")
  call noxfinish()
 call t_stopf("cism:glide:JFNK_noxfinish")
...
!==============================================================================
 ...
 call t_startf("cism:glide:JFNK_SLAP")
 call slapsolve(xk_1, xk_size, c_ptr_to_object, NL_tol, pcgsize)
 call t_stopf("cism:glide:JFNK_SLAP")

! k = 1

#endif  

 call t_startf("cism:glide:JFNK_post")
...
!        locally owned velocity points.
 ...
 call t_stopf("cism:glide:JFNK_post")
...
! precondition v component 
      ...
      answer = 0.d0 ! initial guess
      vectp(:) = wk1(1:nu1) ! rhs for precond v
 call t_startf("cism:glide:nox_precond_v")
      if (whatsparse /= STANDALONE_TRILINOS_SOLVER) then
         call sparse_easy_solve(matrixA, vectp, answer, err, iter, whichsparse, nonlinear_solver = nonlinear)
#ifdef TRILINOS
      else
...
!         write(*,*) 'Total linear solve time so far', totalLinearSolveTime
 ...
 call t_stopf("cism:glide:nox_precond_v")
      wk2(1:nu1) = answer(:)
...
! precondition u component 
      ...
      answer = 0.d0 ! initial guess
      vectp(:) = wk1(nu1+1:nu2) ! rhs for precond u
 call t_startf("cism:glide:nox_precond_u")
      if (whatsparse /= STANDALONE_TRILINOS_SOLVER) then
         call sparse_easy_solve(matrixC, vectp, answer, err, iter, whichsparse, nonlinear_solver = nonlinear)
#ifdef TRILINOS
      else
...
!         write(*,*) 'Total linear solve time so far', totalLinearSolveTime
 ...
 call t_stopf("cism:glide:nox_precond_u")
      wk2(nu1+1:nu2) = answer(:)
...
!  real(dp) :: Ft(xk_size)   !! used for output of residual fields (ures,vres,magres) 
 ...
 call t_startf("cism:glide:Calc_F")
  call c_f_pointer(c_ptr_to_object,fptr) ! convert C ptr to F ptr= model
...
! temporary to test JFNK -  need to take out
  ...
  call solver_postprocess_jfnk( ewn, nsn, upn, ui, &
    ...
    ! coordinate halos for updated uvel and vvel
 call t_startf("cism:glide:Calc_F_uvhalo_upd")
    call staggered_parallel_halo(uvel)
    call staggered_parallel_halo(vvel)
 call t_stopf("cism:glide:Calc_F_uvhalo_upd")

 call t_startf("cism:glide:Calc_F_findefvsstr")
    call findefvsstr(ewn,  nsn,  upn,       &
                     stagsigma,  counter,  &
                     whichefvs,  efvs,     &
                     uvel,       vvel,     &
                     ...
                     dusrfdns,   dthckdns, &
                     um)
 call t_stopf("cism:glide:Calc_F_findefvsstr")
...
!==============================================================================
 ...
 call t_startf("cism:glide:Calc_F_findcoefstr1")
    call findcoefstr(ewn,  nsn,   upn,            &
                     dew,  dns,   sigma,          &
                     2,           efvs,           &
                     vvel,        uvel,           &
 ...
 call t_stopf("cism:glide:Calc_F_findcoefstr1")

    rhsx(1:pcgsize(1)) = rhsd ! Fv

    if (whatsparse /= STANDALONE_TRILINOS_SOLVER) then
 call t_startf("cism:glide:Calc_F_form_matrix1")
      call form_matrix ( matrixA ) ! to get A(utp,vtp)
 call t_stopf("cism:glide:Calc_F_form_matrix1")
#ifdef TRILINOS
    else
      if (ispert == 0) then
 call t_startf("cism:glide:Calc_F_savetrilinos1")
        call savetrilinosmatrix(0); 
 call t_stopf("cism:glide:Calc_F_savetrilinos1")
      endif
#endif
    end if
 ...
 call t_startf("cism:glide:Calc_F_res_vect")
    call res_vect(matrixA, vectp, rhsd, pcgsize(1),  gxf, L2square, whatsparse)
 call t_stopf("cism:glide:Calc_F_res_vect")
    L2norm=L2square
...
!==============================================================================
 ...
 call t_startf("cism:glide:Calc_F_findcoefstr2")
 ...
 call t_stopf("cism:glide:Calc_F_findcoefstr2")

    rhsx(pcgsize(1)+1:2*pcgsize(1)) = rhsd ! Fv

    if (whatsparse /= STANDALONE_TRILINOS_SOLVER) then
 call t_startf("cism:glide:Calc_F_form_matrix2")
      call form_matrix ( matrixC ) ! to get C(utp,vtp)
 call t_stopf("cism:glide:Calc_F_form_matrix2")
#ifdef TRILINOS
    else
      if (ispert == 0) then
 call t_startf("cism:glide:Calc_F_savetrilinos2")
        call savetrilinosmatrix(1); 
 call t_stopf("cism:glide:Calc_F_savetrilinos2")
      endif
#endif
    end if
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 ...
 call t_stopf("cism:glide:Calc_F")
...
call t_startf("cism:glide:res_vect_matvec")
      if (whatsparse /= STANDALONE_TRILINOS_SOLVER) then
...
call t_stopf("cism:glide:res_vect_matvec")
...
call t_startf("cism:glide:res_vect_reduce")
      L2square = parallel_reduce_sum(L2square)
call t_stopf("cism:glide:res_vect_reduce")
