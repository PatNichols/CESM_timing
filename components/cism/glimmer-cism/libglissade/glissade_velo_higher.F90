...
!    logical, parameter :: test_trilinos = .true.
    ...
    call t_startf('cism:gliss:glissade_vhs_init')
    rtest = -999
    itest = 1
    jtest = 1
...
!pw call t_startf('cism:gliss:glissade_velo_higher_scale_input')
    call glissade_velo_higher_scale_input(dx,      dy,            &
                                          ...
                                          uvel,    vvel,          &
                                          uvel_2d, vvel_2d)
!pw call t_stopf('cism:gliss:glissade_velo_higher_scale_input')
...
!pw call t_startf('cism:gliss:glissade_stagger')
    ...
    call glissade_stagger(nx,       ny,         &
                          usrf,     stagusrf,   &
                          ice_mask, stagger_margin_in = 1)
!pw call t_stopf('cism:gliss:glissade_stagger')
...
!pw call t_startf('cism:gliss:glissade_gradient')
...
!pw call t_stopf('cism:gliss:glissade_gradient')
...
!pw call t_startf('cism:gliss:glissade_get_vertex_geom')
...
!pw call t_stopf('cism:gliss:glissade_get_vertex_geom')
    ...
    call t_startf('cism:gliss:glissade_halo_nodeID')
    call staggered_parallel_halo(nodeID)
    call staggered_parallel_halo(vertexID)
    call t_stopf('cism:gliss:glissade_halo_nodeID')
    ...
    if (whichsparse == HO_SPARSE_TRILINOS) then   
       ...
       if (solve_2d) then
          ...
          call t_startf('cism:gliss:glissade_trilinos_fill_pattern')
          call trilinos_fill_pattern_2d(nx,            ny,              &
                                        active_vertex, nVerticesSolve,  &
                                        iVertexIndex,  jVertexIndex,    &
                                        indxA_2d,      Afill_2d)
          call t_stopf('cism:gliss:glissade_trilinos_fill_pattern')
    ...
    call t_startf('cism:gliss:glissade_load_vector_gravity')
    ...
    call t_stopf('cism:gliss:glissade_load_vector_gravity')
    ...
    call t_startf('cism:gliss:glissade_load_vector_lateral_bc')
    call load_vector_lateral_bc(nx,               ny,              &
                                ...
                                stagusrf,         stagthck,        &
                                loadu,            loadv)
    call t_stopf('cism:gliss:glissade_load_vector_lateral_bc')

    call t_stopf('cism:gliss:glissade_vhs_init')
    ...
    call t_startf('cism:gliss:glissade_vhs_nonlinear_loop')
...
!!                do i = 1, nx-1
       ...
       if (solve_2d) then  ! assemble 2D matrix
          ...
          call t_startf('cism:gliss:glissade_assemble_2d')
...
!!                   do i = 1, nx-1
          ...
          call t_stopf('cism:gliss:glissade_assemble_2d')
          ...
          call t_startf('cism:gliss:glissade_dirichlet_2d')
          call dirichlet_boundary_conditions_2d(nx,                       ny,                      &
                                                ...
                                                Avu_2d,                   Avv_2d,                  &
                                                bu_2d,                    bv_2d)
          call t_stopf('cism:gliss:glissade_dirichlet_2d')
          ...
          call t_startf('cism:gliss:glissade_halo_Axxs')
          ...
          call t_stopf('cism:gliss:glissade_halo_Axxs')
          ...
          call t_startf('cism:gliss:glissade_halo_bxxs')
          call staggered_parallel_halo(bu_2d(:,:))
          call staggered_parallel_halo(bv_2d(:,:))
          call t_stopf('cism:gliss:glissade_halo_bxxs')
          ...
          if (check_symmetry) then
             ...
             call t_startf('cism:gliss:glissade_chk_symmetry')
             call check_symmetry_assembled_matrix_2d(nx,          ny,      &
                                                     nhalo,                &
                                                     active_vertex,        &
                                                     Auu_2d,      Auv_2d,  &
                                                     Avu_2d,      Avv_2d)
             call t_stopf('cism:gliss:glissade_chk_symmetry')
          ...
          if (write_matrix) then
             if (counter == 1) then    ! first outer iteration only
                ...
                call t_startf('cism:gliss:glissade_wrt_mat')
                call write_matrix_elements_2d(nx,             ny,            &
                                              ...
                                              Avu_2d,         Avv_2d,        &
                                              bu_2d,          bv_2d)
                call t_stopf('cism:gliss:glissade_wrt_mat')
...
!!             do i = 1, nx-1
          ...
          call t_startf('cism:gliss:glissade_assemble_3d')
          call assemble_stiffness_matrix_3d(nx,               ny,              &
                                            ...
                                            Auu,              Auv,             &
                                            Avu,              Avv)
          call t_stopf('cism:gliss:glissade_assemble_3d')
          ...
          call t_startf('cism:gliss:glissade_dirichlet_3d')
       ...
       if (nNonzeros == 0) then  ! clean up and return
          ...
          call t_startf('cism:gliss:glissade_velo_higher_scale_outp')
          call glissade_velo_higher_scale_output(thck,    usrf,          &
                                                 ...
                                                 tau_xx,  tau_yy,        &
                                                 tau_xy,  tau_eff)
          call t_stopf('cism:gliss:glissade_velo_higher_scale_outp')
       ...
       elseif (whichsparse == HO_SPARSE_PCG_STANDARD .or.   &
          ...
          if (solve_2d) then
             ...
             call t_startf('cism:gliss:glissade_resid_vec')
             ...
             call t_stopf('cism:gliss:glissade_resid_vec')
             ...
             call t_startf('cism:gliss:glissade_pcg_slv_struct')
          ...
          call t_stopf('cism:gliss:glissade_pcg_slv_struct')
       ...
       elseif (whichsparse == HO_SPARSE_TRILINOS) then   ! solve with Trilinos
          ...
          if (solve_2d) then
             ...
             call t_startf('cism:gliss:glissade_trilinos_assemble')
             call trilinos_assemble_2d(nx,             ny,               &   
                                       ...
                                       Avu_2d,         Avv_2d,           &
                                       bu_2d,          bv_2d)
             call t_stopf('cism:gliss:glissade_trilinos_assemble')
             ...
             call t_startf('cism:gliss:glissade_vel_tgs')
             call solvevelocitytgs(velocityResult)
             call t_stopf('cism:gliss:glissade_vel_tgs')

             !------------------------------------------------------------------------
             ! Put the velocity solution back into 2D arrays
             !------------------------------------------------------------------------

             call t_startf('cism:gliss:glissade_trilinos_post')
             call trilinos_extract_velocity_2d(nx,            ny,           &
                                               nVerticesSolve,              &
                                               iVertexIndex,  jVertexIndex, &
                                               velocityResult,              &
                                               uvel_2d,       vvel_2d)
             call t_stopf('cism:gliss:glissade_trilinos_post')
          ...
          call t_startf('cism:gliss:glissade_slap_preprocess')
          if (solve_2d) then
          ...
          call t_stopf('cism:gliss:glissade_slap_preprocess')

          !------------------------------------------------------------------------
          ! Compute the residual vector and its L2_norm
          !------------------------------------------------------------------------

          call t_startf('cism:gliss:glissade_slap_resid_vec')
          call slap_compute_residual_vector(matrix,  answer,    &
                                            rhs,     resid_vec, &
                                            L2_norm, L2_norm_relative)
          call t_stopf('cism:gliss:glissade_slap_resid_vec')
          ...
          call t_startf('cism:gliss:glissade_easy_slv')
          call sparse_easy_solve(matrix, rhs,    answer,  &
                                 err,    niters, whichsparse)
          call t_stopf('cism:gliss:glissade_easy_slv')

          !------------------------------------------------------------------------
          ! Put the velocity solution back into the uvel and vvel arrays
          !------------------------------------------------------------------------

          call t_startf('cism:gliss:glissade_slap_post')
          ...
          call t_stopf('cism:gliss:glissade_slap_post')
       ...
       if (solve_2d) then
          ...
          call t_startf('cism:gliss:glissade_halo_xvel')
          call staggered_parallel_halo(uvel_2d)
          call staggered_parallel_halo(vvel_2d)
          call t_stopf('cism:gliss:glissade_halo_xvel')
          ...
          call t_startf('cism:gliss:glissade_resid_vec2')
          call compute_residual_velocity_2d(nhalo,    whichresid,   &
                                            uvel_2d,  vvel_2d,      &
                                            usav_2d,  vsav_2d,      &
                                            resid_velo)
          call t_stopf('cism:gliss:glissade_resid_vec2')
    ...
    call t_stopf('cism:gliss:glissade_vhs_nonlinear_loop')
...
!!             do i = 1, nx-1
    ...
    call t_startf('cism:gliss:glissade_vhs_cleanup')
    if (whichsparse <= HO_SPARSE_GMRES) then  ! using SLAP solver
...
!pw call t_startf('cism:gliss:glissade_velo_higher_scale_output')
    call glissade_velo_higher_scale_output(thck,    usrf,          &
                                           topg,                   &
                                           flwa,    efvs,          &
                                           bwat,    mintauf,       &
                                           ...
                                           tau_xx,  tau_yy,        &
                                           tau_xy,  tau_eff)
!pw call t_stopf('cism:gliss:glissade_velo_higher_scale_output')
    call t_stopf('cism:gliss:glissade_vhs_cleanup')
...
!          call t_startf('cism:gliss:glissade_effective_viscosity')
                call compute_effective_viscosity(whichefvs,        whichapprox,                       &
                                                 ...
                                                 i, j, k, p )
!          call t_stopf('cism:gliss:glissade_effective_viscosity')
...
!          call t_startf('cism:gliss:glissade_compute_element_matrix')
                call compute_element_matrix(whichapprox,     nNodesPerElement_3d,               & 
                                            ...
                                            Kvu(:,:),        Kvv(:,:),                          &
                                            i, j, k, p )
!          call t_stopf('cism:gliss:glissade_compute_element_matrix')
