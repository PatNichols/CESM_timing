...
!-----------------------------------------------------------------------
    ...
    call t_startf('clm:'//trim(subname)//'_total')
    ...
    if (debug > 1) call t_startf('clm:'//trim(subname)//'_pack')
    ...
    if (debug > 1) call t_stopf('clm:'//trim(subname)//'_pack')
    if (debug > 1) call t_startf('clm:'//trim(subname)//'_scat')

    call mct_aVect_scatter(AVi, AVo, gsmap, 0, mpicom)

    if (debug > 1) call t_stopf('clm:'//trim(subname)//'_scat')
    if (debug > 1) call t_startf('clm:'//trim(subname)//'_upck')
    ...
    if (debug > 1) call t_stopf('clm:'//trim(subname)//'_upck')
    ...
    call t_stopf('clm:'//trim(subname)//'_total')
...
!-----------------------------------------------------------------------
    ...
    if (debug > 1) call t_stopf('clm:'//trim(subname)//'_pack')
    if (debug > 1) call t_startf('clm:'//trim(subname)//'_gath')
...
!       call mct_aVect_gather(AVi, AVo, gsmap, 0, mpicom, missing = missing)
    ...
    if (debug > 1) call t_stopf('clm:'//trim(subname)//'_gath')
    if (debug > 1) call t_startf('clm:'//trim(subname)//'_upck')
