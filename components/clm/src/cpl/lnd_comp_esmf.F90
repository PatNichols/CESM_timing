...
contains
  ...
  subroutine lnd_run_esmf(comp, import_state, export_state, EClock, rc)
    ...
    call t_stopf ('clm:lc_lnd_run1')

    ! Map ESMF to CLM data type

    call t_startf ('clm:lc_lnd_import')
    ...
    call t_stopf ('clm:lc_lnd_import')
    ...
    do while(.not. dosend)
       ...
       call lnd_export(bounds, lnd2atm_inst, lnd2glc_inst, fptr)
       call t_stopf ('clm:lc_lnd_export')

       ! Advance clm time step

       call t_startf ('clm:lc_clm2_adv_timestep')
       call advance_timestep()
       call t_stopf ('clm:lc_clm2_adv_timestep')

    end do

    call t_stopf ('clm:lc_lnd_run2')
    call t_startf('clm:lc_lnd_run3')
