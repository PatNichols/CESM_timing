  ...
  subroutine hist_htapes_wrapup( rstwr, nlend, bounds, &
    ...
    do t = 1, ntapes
       ...
       if (tape(t)%is_endhist) then
          ...
          if (tape(t)%ntimes == 1) then
             call t_startf('clm:hist_htapes_wrapup_define')
             ...
             call t_stopf('clm:hist_htapes_wrapup_define')
          endif

          call t_startf('clm:hist_htapes_wrapup_tconst')
          ...
          tape(t)%begtime = time
          call t_stopf('clm:hist_htapes_wrapup_tconst')

          ! Write history time samples
          call t_startf('clm:hist_htapes_wrapup_write')
          call hfields_write(t, mode='write')
          call t_stopf('clm:hist_htapes_wrapup_write')
