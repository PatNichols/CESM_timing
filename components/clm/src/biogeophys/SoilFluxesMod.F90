...
contains
  ...
  subroutine SoilFluxes (bounds, num_urbanl, filter_urbanl, &
    ...
    associate(                                                                & 
      ...
      call t_stopf('clm:bgp2_loop_1')
      call t_startf('clm:bgp2_loop_2')
      ...
      call t_stopf('clm:bgp2_loop_2')
      call t_startf('clm:bgp2_loop_3')
      ...
      call t_stopf('clm:bgp2_loop_3')
      call t_startf('clm:bgp2_loop_4')
