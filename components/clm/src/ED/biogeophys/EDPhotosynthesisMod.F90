      ...
      do f = 1,fn
         ...
         if (patch%is_veg(p)) then
	       ...
	       kp25top(FT)   = 20000._r8 * vcmax25top(FT)
            ...
            call t_stopf('clm:edfluxes')
            call t_startf('clm:edunpack')
            ...
            if(currentPatch%countcohorts > 0.0)then  !avoid errors caused by empty patches 
               ...
               do while (associated(currentCohort)) ! Cohort loop
                  call t_startf('clm:edfluxunpack1')
                  if(currentCohort%n > 0._r8)then   
                     ...
                     call t_stopf('clm:edfluxunpack1')      
                     call t_startf('clm:edfluxunpack2')
                     ...
                     call t_stopf('clm:edfluxunpack2')
                     call t_startf('clm:edfluxunpack3')
         ...
         call t_stopf('clm:edfluxunpack3')
         call t_stopf('clm:edunpack')  
