...
contains
  ...
  subroutine CNDriverNoLeaching(bounds,                                                    &
    ...
    call t_startf('clm:CNDecompAlloc')
    ...
    call t_stopf('clm:CNDecompAlloc')
    ...
    call t_startf('clm:SoilBiogeochemDecomp')
    ...
    call t_stopf('clm:SoilBiogeochemDecomp')
    ...
    call t_stopf('clm:CNPhenology')

    !--------------------------------------------
    ! Growth respiration
    !--------------------------------------------

    call t_startf('clm:CNGResp')
    ...
    call t_stopf('clm:CNUpdate0')

    !--------------------------------------------
    ! Update1
    !--------------------------------------------

    call t_startf('clm:CNUpdate1')
    ...
    call t_stopf('clm:CNUpdate1')

    !--------------------------------------------
    ! Calculate vertical mixing of soil and litter pools
    !--------------------------------------------

    call t_startf('clm:SoilBiogeochemLittVertTransp')
    ...
    call t_stopf('clm:SoilBiogeochemLittVertTransp')

    !--------------------------------------------
    ! Calculate the gap mortality carbon and nitrogen fluxes
    !--------------------------------------------

    call t_startf('clm:CNGapMortality')
    ...
    call t_stopf('clm:CNGapMortality')

    !--------------------------------------------
    ! Update2 (gap mortality)
    !--------------------------------------------

    call t_startf('clm:CNUpdate2')
